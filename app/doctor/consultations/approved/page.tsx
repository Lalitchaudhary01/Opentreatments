// app/doctor/consultations/approved/page.tsx
...
export default async function ApprovedConsultationsPage() {
        ...
        <main className="flex-1 flex flex-col h-screen overflow-y-auto">
            ...
            <div className="flex-1 max-w-xl">
              <div className="flex w-full items-stretch rounded-2xl h-12">
                ...
                <input
                  ...
                  placeholder="Search approved consultations..."
                />
              </div>
            </div>
          ...
          <div className="px-6 py-4 flex-1">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="bg-green-100 text-green-800 dark:bg-green-800/40 dark:text-green-100 px-4 py-2 rounded-full text-sm font-medium">
                {approvedConsultations.length} scheduled
              </span>
            </div>
