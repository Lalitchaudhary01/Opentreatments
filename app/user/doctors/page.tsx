...
import DoctorSpecialties from "@/features/user-doctors/components/DoctorSpecialties";
import CommonHealthConcerns from "@/features/user-doctors/components/CommonHealthConcerns";
const fadeInUp = {
