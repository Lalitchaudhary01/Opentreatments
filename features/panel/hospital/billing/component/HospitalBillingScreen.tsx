    ...
    <div className="px-6 py-5">
      ...
      <section className="mt-4 overflow-hidden rounded-[14px] border border-slate-200 dark:border-white/[0.07] bg-white dark:bg-[#161f30]">
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 dark:border-white/[0.07] px-5 py-4">
          <div>
            <h2 className="text-[13px] font-semibold text-slate-900 dark:text-[#f1f5f9]">Invoices & Payments</h2>
            <p className="mt-0.5 text-[11px] text-slate-500 dark:text-[#94a3b8]">All billing · today</p>
          </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full border-collapse">
            ...
            <tbody>
              {rows.map((row) => (
                <tr key={row[0]} className="border-t border-slate-200 dark:border-white/[0.07] text-[12.5px] text-slate-500 dark:text-[#94a3b8] hover:bg-slate-100 dark:hover:bg-slate-50 dark:bg-white/[0.02]">
                  <td className="px-5 py-3 font-mono text-[11px] text-[#60a5fa]">{row[0]}</td>
                  <td className="px-5 py-3 font-medium text-slate-900 dark:text-[#e2e8f0]">{row[1]}</td>
                  <td className="px-5 py-3">{row[2]}</td>
                  <td className="px-5 py-3 font-semibold text-slate-900 dark:text-[#f1f5f9]">{row[3]}</td>
                  ...
                  <td className={`px-5 py-3 font-mono text-[11px] ${row[6] === 'Overdue' ? 'text-[#f87171]' : 'text-slate-700 dark:text-[#cbd5e1]'}`}>{row[5]}</td>
                  ...
                  <td className="px-5 py-3 text-right">
                    <div className="inline-flex items-center gap-1.5">
                      <button className="rounded border border-slate-200 dark:border-white/[0.08] bg-slate-100 dark:bg-white/[0.04] px-2.5 py-1 text-[11px] text-slate-500 dark:text-[#94a3b8] hover:bg-slate-200 dark:hover:bg-white/[0.08]">View</button>
        ...
        <div className="flex items-center justify-between border-t border-slate-200 dark:border-white/[0.07] px-5 py-3">
          ...
          <button className="rounded border border-slate-200 dark:border-white/[0.08] bg-slate-100 dark:bg-white/[0.04] px-2.5 py-1 text-[11px] text-slate-500 dark:text-[#94a3b8] hover:bg-slate-200 dark:hover:bg-white/[0.08]">Load More</button>
        </div>
      </section>
    </div>
  );
