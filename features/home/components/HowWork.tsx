    ...
    <section id="how-it-works" className="py-20 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center bg-[#ECFDF5] rounded-xl shadow p-6 transition-transform duration-200 hover:scale-105 hover:shadow-lg">
          ...
          <div className="text-center bg-[#EFF6FF] rounded-xl shadow p-6 transition-transform duration-200 hover:scale-105 hover:shadow-lg">
            <div className="w-16 h-16 bg-[#1FB6E8] rounded-full flex items-center justify-center mx-auto mb-6">
              <Shield className="w-8 h-8 text-white" />
            </div>
            <h3 className="text-xl font-semibold mb-4 text-[#1FB6E8]">
              2. Check Coverage
            </h3>
            <p className="text-muted-foreground">
          ...
          <div className="text-center bg-[#F3F4F6] rounded-xl shadow p-6 transition-transform duration-200 hover:scale-105 hover:shadow-lg">
