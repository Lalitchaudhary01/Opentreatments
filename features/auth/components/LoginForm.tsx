      ...
      <div id="ob-overlay">
        <div className={`ob-left ${mode === "login" ? "signin-mode" : ""}`}>
          ...
          <div className="ob-brand">
            ...
            <div className="ob-brand-name">Open<span>Treatment</span></div>
          </div>
          ...
          <div className="ob-right-inner">
            {mode === "register" && (
              <div className="ob-step active" id="ob-s0">
                ...
                <button className="ob-social" type="button" onClick={() => signIn("google", { callbackUrl: "/" })}>
                ...
                <button className="ob-social" type="button">Continue with Apple</button>
            ...
            {mode === "login" && (
              <div id="ob-signin-panel" className="show">
                <div className="ob-si-inner ob-login-view">
                  ...
                  <button className="ob-social" type="button" onClick={() => signIn("google", { callbackUrl: "/" })}>Continue with Google</button>
                  <button className="ob-social" type="button">Continue with Apple</button>
